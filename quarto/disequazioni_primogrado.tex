...
Il segno o verso di diseguaglianza divide la disequazione in due parti: la parte sinistra e quella a destra.

Una disequazione può essere o intera\index{Disequazione!intera} o frazionaria\index{Disequazione!frazionaria}, è intera se l'incognita non si trova mai al denominatore, è frazionaria se compare anche al denominatore.
\[\centering
\begin{array}{cc}
\toprule
...
La definizione sembra simile a quella per le equazioni. Per un'equazione abbiamo: <<una soluzione è quel valore che rende vera l'uguaglianza>>  
...
La tecnica per risolvere una disequazione di primo è simile a quello per risolvere una equazione di pari grado, cioè la separazione delle variabili\index{Separazione!variabili}. Un esempio è il seguente. Supponiamo di dover risolvere 
\begin{equation}
...
\end{equation}
La disequazione~\vref{equ:ProdDis1} chiede quando il prodotto\index{Disequazione!prodotto} di due binomi è negativo.  Per ottenere il segno di un prodotto bisogna conoscere il segno dei fattori\index{Fattori!segno} e li applicare la regola dei segni.   
...
Il grafico ci dice che per valori minori di $x$  minori di $2$ la disequazione è vera, per cui possiamo che $x-2$ è negativo per valori minori di due, positivo per valori maggiori di due e vale zero per $x=2$. Se la disequazione è 
\begin{equation}
...
Ritorniamo alla disequazione~\vref{equ:ProdDis1}. La disequazione è un prodotto e voglio sapere quando questo prodotto è negativo. Per conoscere il segno di un prodotto bisogna conoscere il segno dei fattori che lo compongono.  Per comodità e quanto detto prima, sostituisco la disequazione con la disequazione~\vref{equ:ProdDis2} che spezzo nelle due disequazioni~\vref{equ:ProdDis2a} e~\vref{equ:ProdDis2b} 
% \begin{subequations}
% 	\begin{align}
...
\end{aligned}\right .   
\end{equation}
Supponiamo di dover risolvere \begin{equation}
