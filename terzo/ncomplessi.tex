...
\end{esempio}
\begin{definizione}
Dato un numero complesso $z=a+b\uimm$, ò'opposto\index{Numero!Complesso!Oppoto} è il numero $-z=-a-b\uimm$
\end{definizione}
\begin{definizione}
...
\begin{definizione}
Dati due numeri complessi\index{Numero!Complesso!Somma}  $z=a+\uimm b$ e  $z_1=a_1+\uimm b_1$ la somma è il numero \[z+z_1=a+a_1+(b+b_1)\uimm\]
\end{definizione}
...
\begin{definizione}
un sistema di coordinate polari individua la posizione di un punto $P$ nel piano, tramite una coppia $(\rho;\theta)$ dove il primo numero è la distanza del punto detto polo e da un angolo.
\end{definizione}
\begin{figure} %[htbp]
	\centering
