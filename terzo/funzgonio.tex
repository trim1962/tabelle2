...
\begin{figure} %[htbp]
	\centering
\includestandalone[width=\textwidth]{terzo/funzgonioTikz/angolinotevoli}
...
\begin{esempiot}{}{}
Convertire in forma decimale
\end{esempiot}
 Abbiamo un angolo di ampiezza pari a \ang{44;58;48} e vogliamo scriverlo in forma decimale\index{Grado!forma decimale} .Dato che $\ang{;1;}=\dfrac{\ang{1}}{60}$ e che $\ang{;;1}=\dfrac{\ang{;1;}}{60}=\dfrac{\ang{1}}{3600}$  avremo
\begin{align*}
...
\begin{figure}
	\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/radianti}
	\caption{Radianti}
...
\begin{figure}
	\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/circonferenzagoniometrica}
...
\begin{figure}
		\centering
\includestandalone[width=7.5cm]{terzo/funzgonioTikz/andamentocoseno1}
		\captionof{figure}{Andamento coseno $\ang{0}<\alpha<\ang{180}$}\label{fig:AndamentoCoseno1}
	\end{figure}%
	\begin{figure}
		\centering
\includestandalone[width=7.5cm]{terzo/funzgonioTikz/andamentocoseno2}
...
\begin{definizionet}{Seno}{}
	Data una circonferenza goniometrica\nobs\vref{sub:senodef}, disegno un angolo con centro nell'origine e di ampiezza $\alpha$. Un lato dell'angolo incontra la circonferenza in un punto $P$.  Chiamo seno\index{Funzione!Seno!definizione} dell'angolo $\alpha$ e lo indico con $\sin\alpha$ l'ordinata $OQ$  del punto $P$
\end{definizionet}
...
\begin{figure}
	\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/andamentoseno1}
	\captionof{figure}{Andamento seno $\ang{0}<\alpha<\ang{180}$}\label{fig:AndamentoSeno1}
\end{figure}%
\begin{figure}
	\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/andamentoseno2}
...
\begin{definizionet}{Tangente}{}
	Data una circonferenza goniometrica\nobs\vref{fig:TangenteDefinizione}, disegno un angolo con centro nell'origine e di ampiezza $\alpha$. Un lato dell'angolo incontra la tangente  alla circonferenza  per $(1;0)$ in un punto $T$.  Chiamo tangente\index{Funzione!Tangente!definizione} dell'angolo $\alpha$ e lo indico con $\tan\alpha$ l'ordinata  del punto $T$
\end{definizionet}
\label{sec:Tangente}
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
...
\begin{figure}
	\centering
\includestandalone[width=7.5cm]{terzo/funzgonioTikz/tangenteandamento1}
	\captionof{figure}{Andamento tangente $\ang{0}<\alpha<\ang{180}$}\label{fig:AndamentoTangente1}
\end{figure}%
\begin{figure}
	\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/tangenteandamento2}
...
\begin{definizionet}{Cotangente}{}
	Data una circonferenza goniometrica\nobs\vref{fig:CotangenteDefinizione}, disegno un angolo con centro nell'origine e di ampiezza $\alpha$. Un lato dell'angolo incontra la tangente  alla circonferenza  per $(0;1)$ in un punto $C$.  Chiamo cotangente\index{Funzione!Cotangente!definizione} dell'angolo $\alpha$ e lo indico con $\cot\alpha$ l'ascissa  del punto $C$
\end{definizionet}
...
\begin{figure}
	\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/cotangenteandamento1}
...
\begin{figure}
	\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/cotangenteandamento2}
...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=8.5cm]{terzo/funzgonioTikz/acrsengrafico}
		\caption{Grafico di $\arcsin x$}
			\label{fig:ArcSenGrafico}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=8.5cm]{terzo/funzgonioTikz/acrcosengrafico}
		\caption{Grafico di $\arccos x$}
		\label{fig:ArcCosenGrafico}
	\end{subfigure}
		\begin{subfigure}[b]{\linewidth}
			\centering
	\includestandalone[width=8.5cm]{terzo/funzgonioTikz/arcotangente}
...
\end{figure}
\subsection{Arcoseno}\index{Funzione!Arcocoseno!definizione}
...
\subsection{Arcoseno}\index{Funzione!Arcoseno!definizione}
...
\subsection{Arcotangente}\index{Funzione!Arcotangente!definizione}
\altapriorita{Inserire definizione arcotangente}
...
\begin{figure}
	\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/RelFondGoniometria}
...
Sono angoli la cui somma\index{Angoli!Somma!$\ang{180}$} è $\ang{180}$, $\alpha$, $\ang{180}-\alpha$ la figura corrispondente è la\nobs\vref{fig:AngoliAssociatisupplementari}
\begin{figure}
	\centering
...
\label{sub:Dif180}
Gli angoli $\alpha$, $\ang{180}+\alpha$ sono angoli la cui differenza\index{Angoli!Differenza!$\ang{180}$} è $\ang{180}$.  Costruiamo la figura\nobs\vref{fig:AngoliAssociatidiff180}
\begin{figure}
	\centering
...
Sono angoli la cui somma\index{Angoli!Somma!$\ang{90}$} è $\ang{90}$, $\alpha$ e $\ang{90}-\alpha$ la figura corrispondente è la\nobs\vref{fig:angolicomplementari1}
\begin{figure} %[H]
	\centering
...
\end{align*}
\subsection{Angoli la cui differenza\index{Angoli!Differenza!$\ang{90}$} è $\ang{90}$}
...
\end{align*}
\subsection{Angoli la cui differenza\index{Angoli!Differenza!$\ang{270}$} è $\ang{270}$}
...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
			\includestandalone[width=7.5cm]{terzo/funzgonioTikz/EquaElementareSeno1}
			\captionof{figure}{$\sin x=m$\  $0<m<1$}
			\label{fig:EquaElementareSeno1}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
		\includestandalone[width=7.5cm]{terzo/funzgonioTikz/EquaElementareCoseno1}
		\captionof{figure}{$\cos x=m$ $0<m<1$}
		\label{fig:EquaElementareCoseno1}
	\end{subfigure}
	\captionof{figure}{Equazioni Elementari}
	\label{fig:EquaElementareSenoCoseno}
\end{figure}
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
			\includestandalone[width=7.5cm]{terzo/funzgonioTikz/EquaElementareSeno4}
			\captionof{figure}{$\sin x=m$\  $-1<m<0$}
			\label{fig:EquaElementareSeno4}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
		\includestandalone[width=7.5cm]{terzo/funzgonioTikz/EquaElementareCoseno4}
		\captionof{figure}{$\cos x=m$ $-1<m<0$}
...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/EquaElementareSeno2}
	\captionof{figure}{$\sin x=1$}
	\label{fig:EquaElementareSeno2}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/EquaElementareSeno3}
	\captionof{figure}{$\sin x=-1$}
	\label{fig:EquaElementareSeno3}
	\end{subfigure}
	\captionof{figure}{Seno casi particolari}
...
x&=\ang{100}+k\ang{360}
	\end{align*}
\subsection{Equazione $\cos x=m$}
Il coseno di un angolo\index{Equazione!elementare!coseno} è una funzione limitata con valori compresi tra meno uno ed uno $(1\leq\cos x\leq 1)$ quindi l'equazione è impossibile per valori di $m$ esterni a tale intervallo. Abbiamo vari casi:
\begin{description}
...
\begin{figure}
	\begin{subfigure}[b]{.5\linewidth}
		\centering
	\includestandalone[width=7.5cm]{terzo/funzgonioTikz/EquaElementareCoseno3}
	\captionof{figure}{$\cos x=m$ $m=-1$}
	\label{fig:EquaElementareCoseno3}
	\end{subfigure}%
	\begin{subfigure}[b]{.5\linewidth}
		\centering
		\includestandalone[width=7.5cm]{terzo/funzgonioTikz/EquaElementareCoseno2}
		\captionof{figure}{$\cos x=m$ $m=+1$}
		\label{fig:EquaElementareCoseno2}
	\end{subfigure}
	\captionof{figure}{Coseno casi particolari}
...
& \beta\neq\ang{90}+k\ang{180}& &\\
&&\alpha=\beta+k\ang{180}  &\\
\midrule
\tan\alpha=-\tan\beta & \alpha\neq\ang{90}+k\ang{180} & &\tan(\ang{180}-\beta)=-\tan(\beta)\\
& \beta\neq\ang{90}+k\ang{180}& &\\
&&\alpha=\ang{180}-\beta+k\ang{180} &\\
\bottomrule
\end{array}
\] 
\caption{Equazioni elementari in tangente}
\label{tab:EquazioniElementariInTangente}
\end{table}