...
\begin{esempiot}{Metodo confronto}{}
	...
	\]
\end{esempiot}
Per trovare le soluzioni di  un sistema con il metodo occorre risolvere le due equazioni rispetto alla stessa incognita e confrontare i risultati ottenuti. Nella prima riga le incognite sono moltiplicate per valori numerici diversi. Nella seconda riga il coefficiente della $x$ vale uno. Quindi ci conviene risolvere rispetto questa incognita da cui   \[
\begin{cases}
3x=5-2y\\
x=6-5y
...
\end{cases}
\]
Il risultato trovato è soluzione per il sistema.
 \begin{esempiot}{Metodo confronto}{}
Supponiamo di avere un sistema lineare in forma normale
\[
\begin{cases}
